  ...
  if (compact) {
    ...
    return (
      <div className="max-w-[280px] mx-auto rounded border-2 border-amber-600/40 bg-[#0a0a0a] px-3 py-1.5">
        <p className="text-[10px] font-[sv170singlestroke,monospace] font-bold text-yellow-400 text-center truncate">{text}</p>
    ...
    <div className="max-w-[280px] mx-auto rounded-md border-2 border-amber-700/50 bg-[#0a0a0a] overflow-hidden shadow-md">
      <div className="px-3 py-2">
        {phase1Lines.map((line, i) => (
          <div key={i} className="text-center text-xs font-[sv170singlestroke,monospace] font-bold tracking-[0.15em] text-yellow-400 leading-relaxed uppercase">
            {line || '\u00A0'}
          </div>
        ))}
